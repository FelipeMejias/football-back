...
export const bancoAmericaSul=[]
export const bancoAmericaNorte=[]
export const bancoEuropa=[]
export const bancoAfrica=[]
export const bancoAsia=[]
...
async function iniciateDatabases(){
   ...
   await createBra1()
   idGeral=0
   bancoGeral=bancoAmericaSul
   await createAmericaSul()
   bancoGeral=bancoEuropa
   await createEuropa()
}
...
async function create(rodada,times,goals){
   ...
   let visitante
   if(times.length>6){
      const listOf2=times.split(' ')
      mandante=listOf2[0]
      visitante=listOf2[1]
   }else{
      mandante=times[0]+times[1]+times[2]
      visitante=times[3]+times[4]+times[5]
   }
   const gols=[]
...
async function createAmericaSul(){
   let r
   r=2//================== RODADA 2 =====================//
await create(r,'Bolívia arg',[23,-44,-78])
await create(r,'',[])
await create(r,'',[])
await create(r,'',[])
await create(r,'',[])
r=1//================== RODADA 1 =====================//
await create(r,'',[])
await create(r,'uru Chile',[38,-53,90])
await create(r,'arg equ',[12])
await create(r,'',[])
await create(r,'bra Bolívia',[15,29,48,65,72])

}
async function createEuropa(){
   let r
   r=1//================== RODADA 1 =====================//
   await create(r,'',[])
   await create(r,'',[])
...
async function createAmericaNorte(){
   let r
   r=1//================== RODADA 1 =====================//
   await create(r,'',[])
   await create(r,'',[])
